...
--               Training/UART/UART_LED/UART_LED.gen/sources_1/bd/top/ip/top_UART_TX_0_1/top_UART_TX_0_1_sim_netlist.vhdl}
...
entity top_UART_TX_0_1_UART_TX is
  port (
    busy : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of top_UART_TX_0_1_UART_TX : entity is "UART_TX";
end top_UART_TX_0_1_UART_TX;

architecture STRUCTURE of top_UART_TX_0_1_UART_TX is
  ...
  signal \full_frame[8]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \current_index[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \current_index[3]_i_2\ : label is "soft_lutpair1";
...
\full_frame[8]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
entity top_UART_TX_0_1 is
  ...
  attribute NotValidForBitStream of top_UART_TX_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of top_UART_TX_0_1 : entity is "top_UART_TX_0_1,UART_TX,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of top_UART_TX_0_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of top_UART_TX_0_1 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of top_UART_TX_0_1 : entity is "UART_TX,Vivado 2023.2";
end top_UART_TX_0_1;

architecture STRUCTURE of top_UART_TX_0_1 is
  attribute x_interface_info : string;
  attribute x_interface_info of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of clk : signal is "XIL_INTERFACENAME clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
begin
U0: entity work.top_UART_TX_0_1_UART_TX
     port map (
      busy => busy,
      clk => clk,
