...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ASCII_LUT is
  ...
  signal \S_TX_BYTE_OUT[4]_i_3_n_0\ : STD_LOGIC;
  signal \S_TX_BYTE_OUT[4]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \S_TX_BYTE_OUT[3]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \S_TX_BYTE_OUT[4]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \S_TX_BYTE_OUT[4]_i_4\ : label is "soft_lutpair5";
...
\S_TX_BYTE_OUT[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \S_TX_BYTE_OUT[4]_i_3_n_0\,
      I2 => TX_BYTE(2),
      I3 => TX_BYTE(4),
      I4 => TX_BYTE(5),
      I5 => \S_TX_BYTE_OUT[4]_i_4_n_0\,
      O => \S_TX_BYTE_OUT[3]_i_1_n_0\
    );
\S_TX_BYTE_OUT[3]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00044404"
    )
        port map (
...
\S_TX_BYTE_OUT[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\S_TX_BYTE_OUT[4]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F7"
    )
        port map (
      ...
      I1 => TX_BYTE(1),
      I2 => TX_BYTE(0),
      O => \S_TX_BYTE_OUT[4]_i_3_n_0\
    );
\S_TX_BYTE_OUT[4]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
