...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_CONTROLLER is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[3]_i_3\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \FSM_sequential_state[3]_i_6\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \RX_DATA_FULL[31]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of RX_DATA_READY_i_2 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \TX_BYTE_OUT[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \TX_BYTE_OUT[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \TX_BYTE_OUT[3]_i_2\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \TX_BYTE_OUT[5]_i_3\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \TX_BYTE_OUT[5]_i_4\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \TX_DATA_HOLD[29]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \TX_DATA_HOLD[30]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \TX_DATA_HOLD[31]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \TX_DATA_HOLD[31]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \byte_counter[1]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \byte_counter[1]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \byte_counter[2]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \byte_counter[3]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \byte_counter[3]_i_5\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \byte_counter[3]_i_6\ : label is "soft_lutpair6";
...
\TX_BYTE_OUT[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000400"
    )
        port map (
