...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ASCII_LUT is
  ...
  attribute SOFT_HLUTNM of \S_TX_BYTE_OUT[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \S_TX_BYTE_OUT[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \S_TX_BYTE_OUT[3]_i_2\ : label is "soft_lutpair5";
...
\S_TX_BYTE_OUT[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"000002AA"
    )
        port map (
...
\S_TX_BYTE_OUT[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FEEE"
    )
        port map (
...
\S_TX_BYTE_OUT[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => TX_BYTE(5),
      I3 => TX_BYTE(0),
      I4 => \S_TX_BYTE_OUT[3]_i_2_n_0\,
      I5 => TX_BYTE(2),
      O => \S_TX_BYTE_OUT[2]_i_1_n_0\
    );
\S_TX_BYTE_OUT[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0011000000030000"
    )
        port map (
      I0 => TX_BYTE(0),
      I1 => \S_TX_BYTE_OUT[3]_i_2_n_0\,
      I2 => TX_BYTE(5),
      I3 => TX_BYTE(2),
      I4 => TX_BYTE(3),
      I5 => TX_BYTE(1),
...
\S_TX_BYTE_OUT[3]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\S_TX_BYTE_OUT[4]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0057"
    )
        port map (
...
\S_TX_BYTE_OUT[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FEFFFFFF"
    )
        port map (
...
\S_TX_BYTE_OUT[5]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
