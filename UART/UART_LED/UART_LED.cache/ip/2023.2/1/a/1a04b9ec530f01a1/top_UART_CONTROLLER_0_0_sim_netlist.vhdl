...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_UART_CONTROLLER is
  ...
  signal TX_BYTE_OUT : STD_LOGIC;
  signal \TX_BYTE_OUT[0]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \TX_BYTE_OUT[4]_i_1_n_0\ : STD_LOGIC;
  signal \TX_BYTE_OUT[5]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \TX_DATA_HOLD[31]_i_4_n_0\ : STD_LOGIC;
  ...
  signal data_buildup : STD_LOGIC_VECTOR ( 31 to 31 );
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[3]_i_7\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \RX_DATA_FULL[31]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of RX_DATA_READY_i_2 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \TX_BYTE_OUT[0]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \TX_BYTE_OUT[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \TX_BYTE_OUT[4]_i_1\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \TX_DATA_HOLD[31]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \TX_DATA_HOLD[4]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \TX_DATA_HOLD[5]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \TX_DATA_HOLD[6]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \byte_counter[1]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \byte_counter[1]_i_3\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \byte_counter[1]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \byte_counter[2]_i_4\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \byte_counter[3]_i_5\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \byte_counter[3]_i_6\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \data_buildup[16]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \data_buildup[17]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \data_buildup[18]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \data_buildup[19]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \data_buildup[27]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \data_buildup[28]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \data_buildup[29]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \data_buildup[30]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \data_buildup[31]_i_3\ : label is "soft_lutpair12";
...
RX_DATA_READY_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2F2F0FCC202000CC"
    )
        port map (
      I0 => RX_BYTE_READY,
      I1 => \state__0\(3),
      I2 => \RX_DATA_FULL[31]_i_1_n_0\,
      I3 => RX_DATA_READY_i_2_n_0,
      I4 => \state__0\(0),
      I5 => \^rx_data_ready\,
      O => RX_DATA_READY_i_1_n_0
    );
RX_DATA_READY_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\TX_BYTE_OUT[4]_i_1\: unisim.vcomponents.LUT2
    generic map(
      ...
      I0 => \state__0\(3),
      I1 => \state__0\(0),
      O => \TX_BYTE_OUT[4]_i_1_n_0\
    );
\TX_BYTE_OUT[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000FCE000000"
    )
        port map (
      I0 => TX_DATA_READY,
      I1 => \TX_BYTE_OUT[5]_i_3_n_0\,
      I2 => \state__0\(0),
      I3 => \state__0\(1),
      I4 => \state__0\(2),
      I5 => \state__0\(3),
...
\TX_DATA_HOLD[31]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"A8"
    )
        port map (
...
\byte_counter[1]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"E0FF"
    )
        port map (
...
\byte_counter[1]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFEEF"
    )
        port map (
...
\byte_counter[2]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\byte_counter[2]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EB"
    )
        port map (
...
\data_buildup[31]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000F00020000000F"
    )
        port map (
      I0 => RX_BYTE_READY,
