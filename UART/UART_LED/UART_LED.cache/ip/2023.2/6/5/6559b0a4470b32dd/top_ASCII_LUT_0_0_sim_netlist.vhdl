...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ASCII_LUT is
  ...
  attribute SOFT_HLUTNM of \ASCII_TYPE[0]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \ASCII_TYPE[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \ASCII_TYPE[2]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \S_RX_BYTE_OUT[0]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \S_RX_BYTE_OUT[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \S_RX_BYTE_OUT[1]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \S_RX_BYTE_OUT[2]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \S_RX_BYTE_OUT[3]_i_3\ : label is "soft_lutpair3";
begin
...
begin
  ...
  TX_BYTE_OUT(5) <= \<const0>\;
  TX_BYTE_OUT(4) <= \<const0>\;
  TX_BYTE_OUT(3) <= \<const0>\;
  TX_BYTE_OUT(2) <= \<const0>\;
  TX_BYTE_OUT(1) <= \<const0>\;
  TX_BYTE_OUT(0) <= \<const0>\;
  TX_BYTE_OUT_READY <= \<const0>\;
